...
class CASAuth(BaseAuth, CASBackend):
    ...
    def extra_data(self, user, uid, response, details=None, *args, **kwargs):  # pylint: disable=W1113
        ...
        try:
            ...
            logger.exception("An exception was raised while loading user_details.")
            data["userinfo_response"] = response
