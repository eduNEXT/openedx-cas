...
"""
openedx-cas documentation build configuration file.
...
project_title = 'Open edX Centrilized Authentication System (CAS)'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Support for Certralized Authentication System (CAS) in the Open edX authentication flows',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'openedx_cas'),
                os.path.join(root_path, 'openedx_cas/migrations')])
